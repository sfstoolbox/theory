...
.. figure:: plane-wave.*
    ...
    :eq:`freq-source-plane-wave` going into the direction :math:`(1, 1, 0)`.
...
.. figure:: point-source.*
    ...
    :eq:`freq-source-point-source` placed at :math:`(0, 0, 0)`.
    Parameters: :math:`f = 800` Hz.
...
.. math::
    :label: freq-source-point-source
...
.. math::
    :label: time-source-point-source
...
.. figure:: dipole-point-source.*
    ...
    :eq:`freq-source-dipole-point-source` placed at
...
.. math::
    :label: freq-source-dipole-point-source
...
.. math::
    :label: time-source-dipole-point-source
...
.. figure:: line-source.*
    ...
    :eq:`freq-source-line-source` placed at :math:`(0, 0, 0)`.  Parameters:
    :math:`f = 800` Hz.

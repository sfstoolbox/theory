...
% The next two lines define a non-italic int symbol                           |
%\DeclareSymbolFont{eulargesymbols}{U}{zeuex}{m}{n}                %           |
%\DeclareMathSymbol{\intop}{\mathop}{eulargesymbols}{"52}          % int       |
...
% --- HYPHENATION ------------------------------------------------------------
\hyphenation{Fesh-bach set-up set-ups Experi-mente %                          |
Aliasing-arte-fakten Uni-ver-si-t\"{a}t}%                                     |
% ----------------------------------------------------------------------------

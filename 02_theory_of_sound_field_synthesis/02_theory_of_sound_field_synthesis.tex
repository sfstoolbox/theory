...
Spors\sidenote[][-0.5cm]{\cite{Zotter2013}} explicitly
...
approximation}.\sidenote[][-3.2cm]{\cite[See][p.\,53--54]{Colton1983}}
...
method.\sidenote[][-3cm]{\cite[E.g.][]{Herrin2003}}
...
sources.\sidenote[][-3.1cm]{\cite[Compare the two assumptions in][made before
...
WFS -- compare
Figure\,\ref{fig:concave_array}.\sidenote[][-2cm]{\cite[See the appendix
in][]{Lax1947}}
This was neglected in most of the literature so far, which postulates
convex secondary source
distributions.\sidenote[][-1cm]{\cite[E.g.][]{Spors2008}}
...
as\sidenote[][0.2cm]{\cite[][(2.38)]{Ahrens2012}}
%
\begin{equation}
...
given as after Ahrens\sidenote[][]{\cite[][(C.5)]{Ahrens2012}}
%
\begin{equation}
...
function as\sidenote[][-6.2cm]{\cite[][(6.73)]{Williams1999}}
%
\begin{equation}
...
\begin{equation}
    ...
    \eqname{D:hoa:pw:2.5D}
    \label{eq:D:hoa:pw:2.5D}
\end{equation}
%
...
\begin{equation}
    ...
    \eqname{D:sdm:pw:2.5D}
    \label{eq:D:sdm:pw:2.5D}
\end{equation}
%
...
\begin{equation}
    ...
    \eqname{D:hoa:ps:2.5D}
    \label{eq:D:hoa:ps:2.5D}
\end{equation}
%
...
\begin{multline}
    ...
    \eqname{D:sdm:ps:2.5D}
    \label{eq:D:sdm:ps:2.5D}
\end{multline}
%
...
focusing.\sidenote[][-0.5cm]{\cite{Yon2003}}
...
evanescent
waves\sidenote[][-0.4cm]{\cite[][p.\,24]{Williams1999}} appear for spatial frequencies $k_x > |\omegac|$.
...
sources.\sidenote[][-1.4cm]{\cite[Compare Fig.\,2a in][]{Spors2010}}
...
\begin{equation}
    ...
    \E^{-\I\omegac\n_k\x_0} \qp
    \eqname{D:wfs:pw:2.5D}
    \label{eq:D:wfs:pw:2.5D}
\end{equation}
%
...
\begin{multline}
    ...
    \eqname{D:wfs:ps:woapprox}
    \label{eq:D:wfs:ps:woapprox}
\end{multline}
%
\begin{multline}
    ...
    \eqname{D:wfs:ps:woapprox:2.5D}
    \label{eq:D:wfs:ps:woapprox:2.5D}
\end{multline}
%
...
\begin{multline}
    ...
    \frac{(\x_0-\xs)\n_{\x_0}}{|\x_0-\xs|^{\nicefrac{3}{2}}}
    \E^{-\I\omegac |\x_0-\xs|} \qc
    \eqname{D:wfs:ps:2.5D}
    \label{eq:D:wfs:ps:2.5D}
\end{multline}
%
...
\begin{multline}
    ...
    \eqname{D:wfs:ls:2.5D}
    \label{eq:D:wfs:ls:2.5D}
\end{multline}
%
\begin{marginfigure}
    \centering
...
\begin{multline}
    ...
    \frac{1}{|\x_0-\xs|} \right) \frac{(\x_0-\xs)\n_{\x_0}}{|\x_0-\xs|^2}
    \E^{\I\omegac |\x_0-\xs|} \qc
    \eqname{D:wfs:fs:woapprox}
    \label{eq:D:wfs:fs:woapprox}
\end{multline}
%
\begin{multline}
    D_\twohalfD(\x_0,\omega) = \\
    ...
    \qc
    \eqname{D:wfs:fs:woapprox:2.5D}
    \label{eq:D:wfs:fs:woapprox:2.5D}
\end{multline}
%
...
\begin{equation}
    ...
    \eqname{D:wfs:fs:2.5D}
    \label{eq:D:wfs:fs:2.5D}
\end{equation}
%
...
%
\urlnote{driving\_function\_mono\_localwfs.m}{\SFS/SFS_monochromatic/driving_function_mono_localwfs.m}
...
the driving signals
%
\urlnote{driving\_function\_imp\_localwfs.m}{\SFS/SFS_time_domain/driving\_function\_imp\_localwfs.m}

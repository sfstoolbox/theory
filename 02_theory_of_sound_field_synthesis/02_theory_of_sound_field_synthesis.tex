...
\begin{marginfigure}
    ...
    source~(\ref{eq:line_source_omega}) placed at $(0,0,0)$. Parameters: $f =
        800$\,Hz.
...
\begin{marginfigure}
    ...
    \caption{Sound pressure of a monochromatic plane wave synthesized with
        \twohalfD \ac{NFC-HOA}~(\ref{eq:D_nfchoa_pw_25D}). Parameters: $\n_k = (0,-1,0)$,
        $\xref = (0,0,0)$, $f = 1$\,kHz.
...
\begin{marginfigure}[-0.5cm]
    ...
    \twohalfD \ac{WFS}~(\ref{eq:D_wfs_pw_25D}). Parameters: $\n_k = (0,-1,0)$, $\xref
        = (0,0,0)$, $f = 1$\,kHz.
...
\begin{marginfigure}
    ...
    \caption{Sound pressure for a monochromatic point source synthesized by
        \twohalfD \ac{WFS}~(\ref{eq:D_wfs_ps_25D}). Parameters: $\xs = (0,2.5,0)$\,m,
        $\xref = (0,0,0)$, $f = 1$\,kHz.
...
\begin{marginfigure}
    ...
    \caption{Sound pressure of a mono-frequent focused source synthesized with
        \twohalfD \ac{WFS}~(\ref{eq:D_wfs_fs_25D}). Parameters: $\xs = (0,0.5,0)$\,m,

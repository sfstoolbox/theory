...
.. math::
    :label: fd-greens-function-expansion

    G(\x-\x_0, \w) = \sum_{n} \tilde{G}_n(\w) \psi_n^*(\x_0) \psi_n(\x)

.. math::
    :label: fd-drivingfunction-expansion

    D(\x_0, \w) = \sum_n \tilde{D}_n(\w) \psi_n(\x_0)

.. math::
    :label: fd-source-expansion
...
.. math::
    :label: fd-greens-function-expansion-non-compact

    G(\x-\x_0, \w) = \int \tilde{G}(\mu, \w) \psi^*(\mu, \x_0)
        \psi(\mu, \x) \d\mu

.. math::
    :label: fd-drivingfunction-expansion-non-compact

    D(\x_0, \w) = \int \tilde{D}(\mu, \w) \psi(\mu, \x_0) \d\mu

.. math::
    :label: fd-source-expansion-non-compact
...
:eq:`fd-drivingfunction-hoa` follows directly via the convolution theorem
...
.. math::
    :label: fd-drivingfunction-spherical
...
.. math::
    :label: fd-greens-function-spherical
...
.. math::
    :label: fd-drivingfunction-circular
...
.. math::
    :label: fd-greens-function-circular
...
.. math::
    :label: fd-drivingfunction-planar
...
.. math::
    :label: fd-greens-function-planar
...
.. math::
    :label: fd-drivingfunction-linear
...
.. math::
    :label: fd-greens-function-linear
